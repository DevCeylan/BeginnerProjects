// Selector and variable for "order button"
// Event listener and function at the end
...
function sendData(jsonString) {
  ...
  xhr.open("POST", "pushOrder.php");
  xhr.setRequestHeader("Content-type", "application/json");
  xhr.send(jsonString);
}

btnOrder.addEventListener("click", () => {
  // get all items to an array
  const cartArray = shoppingCart.listCart();

  // iterate over the array, stringify and send JSON for each item in cartArray
  for (var i in cartArray) {
    const jsonString = JSON.stringify(cartArray[i]);
